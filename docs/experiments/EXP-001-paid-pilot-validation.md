...
4. identify assumptions, affected deliverables, and clarification questions;
5. draft a client-facing change-order summary;
6. ask the tester whether the result would have changed how they handled the request;
7. record time saved, avoided unpaid work, recovered revenue, or objections.
...
3. Who decided whether it was billable?
4. How long did that decision/change-order process take?
5. Did your team perform any work before commercial approval?
6. What did that cost in time, margin, delay, or client friction?
7. What tools or documents did you use to resolve it?
8. What is the most frustrating part of the current process?
9. If ScopeDelta produced a cited scope comparison and change-order draft in minutes, where would you still distrust or edit it?
10. Would you test it on a real anonymized case? If not, why not?
...
- estimated time/margin impact;
- willingness to share anonymized material;
- willingness to test;
- willingness to pay / objection;
